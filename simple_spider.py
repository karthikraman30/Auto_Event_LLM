...
class SimpleEventSpider(scrapy.Spider):
    ...
    # Only the two URLs we want to scrape
    start_urls = [
                ...
                try:
                    ...
                    if today <= event_date <= limit_date:
                        ...
                        if "forskolor" in response.url:
                            ...
                            # Use the target_group_raw field
                            ...
                            if raw_target and 'målgrupp' in raw_target.lower():
                                ...
                                item['target_group_normalized'] = target_value.lower().replace(' ', '_')
                            else:
                                item['target_group'] = 'All'
                                item['target_group_normalized'] = 'all'
